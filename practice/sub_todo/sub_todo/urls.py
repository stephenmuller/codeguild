...
urlpatterns = [
    ...
    url(r'^add', views.render_add_main_item, name='add_main_item'),
    url(r'^submit', views.render_ack_submit_new_main, name='submit_new_main'),
    url(r'^(?P<main_item_id>.+)/add', views.render_add_sub_item, name='add_sub_item'),
