...
<<<<<<< HEAD
    if input_type == 'in_snake_case':
        output = convert_snake_to_normal(complex_str)

    elif input_type == 'in_camel_case':
        output = convert_camel_to_normal(complex_str)

    elif input_type == 'in_kebab_case':
        output = convert_kebab_to_normal(complex_str)

    else:
        output = convert_constant_to_normal(complex_str)

    return output


def convert_snake_to_normal(complex_str):
    """Takes in snake case and outputs plain list

    >>> convert_snake_to_normal('snake_case')
    ['snake', 'case']
    """

    return complex_str.split('_')


def convert_camel_to_normal(complex_str):
    """Takes in CamelCase and outputs a plain list

    >>> convert_camel_to_normal('CamelCase')
    ['camel', 'case']
    """
...
def convert_kebab_to_normal(complex_str):
    """Converts kebab-case to a normal list of words
    >>> convert_kebab_to_normal('kebab-case')
    ['kebab', 'case']
    """
    return complex_str.split('-')


def convert_constant_to_normal(complex_str):
    """Converts Constant case to a normal list of words
    >>> convert_constant_to_normal('CONSTANT_CASE')
    ['constant', 'case']
    """
